    ...
    <main className="px-4 md:px-8 min-h-screen flex flex-col items-center justify-center">
      <div className="max-w-md w-full">
        <div className="p-6 rounded-lg bg-blue-50/50 border border-blue-300 shadow-xs md:p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-7">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"
                  title="Must contain at least 8 characters, including a number, lowercase, and uppercase letter"
                ...
                >
                  {showPassword ? (
                    <EyeOff size={16} color="#3b83f7" />
                  ) : (
                    <Eye size={16} color="#3b83f7" />
                  )}
                </button>
              </div>
            </div>
          ...
          <div className="text-slate-900 text-sm text-center mt-5">
