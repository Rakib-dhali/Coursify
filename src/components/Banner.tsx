      ...
      <div className="max-w-369 mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="flex flex-col items-center lg:items-start gap-6">
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="inline-flex items-center gap-2 self-center lg:self-start bg-white border border-blue-400 text-blue-700 text-xs font-semibold px-4 py-1.5 rounded-full"
          >
          ...
          <motion.h1
            ...
            initial="hidden"
            animate="visible"
            className="font-extrabold text-center lg:text-start text-5xl sm:text-5xl lg:text-5xl leading-tight tracking-tight text-gray-900"
          >
          ...
          <motion.p
            ...
            initial="hidden"
            animate="visible"
            className="text-gray-500 text-center md:text-left text-base sm:text-lg leading-relaxed max-w-lg"
          >
          ...
          >
            <button
              ...
              className="flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-full transition-all hover:-translate-y-0.5 shadow-lg shadow-blue-200"
            >
              Start Learning
            ...
            <button
              ...
              className="flex items-center gap-2 border border-gray-200 hover:border-red-400 hover:bg-red-50 text-gray-800 font-medium px-6 py-3 rounded-full transition-all"
            >
          ...
          <div className="flex flex-wrap gap-6 pt-2">
            ...
            initial="hidden"
            animate="visible" key={label} className="flex items-center gap-2.5">
          ...
          <div className="absolute -top-4 right-4 z-10 flex items-center gap-2.5 bg-white rounded-2xl shadow-lg px-3.5 py-2.5">
            <div className="flex">
              {["bg-orange-400", "bg-purple-500", "bg-sky-400"].map((c, i) => (
                <div
                  key={i}
                  className={`w-7 h-7 rounded-full ${c} border-2 border-white ${i !== 0 ? "-ml-2" : ""}`}
                />
              ))}
            </div>
            <div>
